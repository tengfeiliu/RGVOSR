...
def main():
    ...
    parser.add_argument("--input", required=True, help="HQ image path, directory, or txt list.")
    parser.add_argument("--lq-output-dir", required=True, help="Directory for generated LQ PNG images.")
    parser.add_argument("--output", required=True, help="Valid merged cache JSONL path.")
    parser.add_argument("--invalid-output", required=True, help="Invalid/error JSONL path.")
